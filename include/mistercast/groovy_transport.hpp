...
private:
 ...
 std::atomic<uint32_t>ackFrame_{0},fpgaFrame_{0};std::atomic<uint16_t>syncLine_{0},fpgaVCount_{0};
 std::atomic<uint64_t>ackedFrames_{0},missedAcks_{0},streamTimeUs_{0},ackAgeMs_{0};std::atomic<int64_t>rasterCorrectionUs_{0};
};
}
